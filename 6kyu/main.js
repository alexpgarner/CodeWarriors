...
//     let numArr = [...String(n)];
//     if(numArr.length>1){
//       let sum = numArr.reduce((accumulator,currentVal)=>accumulator+Number(currentVal),0);
...
//       let found = b.find(val=>(val==value))
//       if(found == undefined){
//         return true;
//       }else if (found == 0){
//         return false;
...
//of course there was a better array method to use
